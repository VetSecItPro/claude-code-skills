...
# Usage: bash <(curl -s https://raw.githubusercontent.com/VetSecItPro/claude-code-skills/main/install.sh)

REPO="https://github.com/VetSecItPro/claude-code-skills.git"
TMPDIR=$(mktemp -d)
...
echo "Try: /dev, /smoketest, /cleancode, /deps, /a11y, /perf, /docs, /design, /blog, /n8n-workflow"
echo ""
echo "Want 12 more premium skills? Visit: https://steelmotionllc.com/portfolio/software/claude-code-skills"
